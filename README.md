...
- Multiple conflict types: modified\_both, deleted\_local, deleted\_remote, added\_both, dir\_file\_conflict

- Resolution options: keep\_local, keep\_remote, merge (with markers), auto resolution
